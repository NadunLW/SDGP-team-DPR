...
export default function App() {
  ...
  const buttonsAnimatedStyle = useAnimatedStyle(() => {
    ...
    return {
      opacity: withTiming(imagePosition.value, { duration: 500 }), // hiding buttons
      transform: [
        { translateY: withTiming(interpolation, { duration: 1000 }) }, // for buttons to move down while dissappear
      ],
    };
  });
